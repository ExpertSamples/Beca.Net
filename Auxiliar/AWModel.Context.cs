...
namespace Ejemplos
{
    ...
    public partial class AdventureWorks2014Entities : DbContext
    {
        ...
        public virtual ObjectResult<AMA_GetProductsByCategory_Result> AMA_GetProductsByCategory(Nullable<int> categoryID)
        {
            var categoryIDParameter = categoryID.HasValue ?
                new ObjectParameter("CategoryID", categoryID) :
                new ObjectParameter("CategoryID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AMA_GetProductsByCategory_Result>("AMA_GetProductsByCategory", categoryIDParameter);
        }
    }
}
